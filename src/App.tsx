...
function getDishDescription(dish: Dish, categoryId?: string): string {
    ...
    if (categoryId === "mangal" || nameLower.includes("шашлык") || nameLower.includes("люля-кебаб") || nameLower.includes("садж") || (nameLower.includes("стейк") && !nameLower.includes("удон"))) {
        if (nameLower.includes("шашлык свиной")) {
            return "Сочный шашлык из отборной свиной шейки, маринованный по традиционному кавказскому рецепту и обжаренный на углях. Подаётся с маринованным луком.";
        }
        if (nameLower.includes("шашлык из курицы с овощами")) {
            return "Аппетитный шашлык из нежного куриного филе с болгарским перцем, томатами и репчатым луком на углях.";
        }
        if (nameLower.includes("шашлык куриный")) {
            return "Нежное куриное филе в авторском маринаде, обжаренное на мангале до румяной корочки.";
        }
        if (nameLower.includes("шашлык из крыльев")) {
            return "Хрустящие куриные крылышки в пикантном маринаде, обжаренные на мангале до золотистого цвета.";
        }
        if (nameLower.includes("люля-кебаб с говядиной")) {
            return "Классический сочный кебаб из рубленой говядины со свежей кинзой, луком и восточными специями на шампуре.";
        }
        if (nameLower.includes("люля-кебаб куриный")) {
            return "Нежный кебаб из рубленого куриного филе с кавказскими пряностями, обжаренный на углях.";
        }
        if (nameLower.includes("садж")) {
            return "Праздничное кавказское блюдо на компанию: сочное ассорти мяса, запечённый картофель, грибы, баклажаны и перцы на подогреваемой сковороде.";
        }
        if (nameLower.includes("стейк из сёмги") || nameLower.includes("стейк из семги")) {
            return "Филе атлантической сёмги на гриле с золотистой корочкой, долькой лимона, маслинами и свежей зеленью.";
        }
        if (nameLower.includes("стейк из говядины")) {
            return "Сочный стейк из отборной говядины с пряным розмарином, идеальной прожаркой и ароматом дымка.";
        }
        if (nameLower.includes("стейк из свинины")) {
            return "Стейк из свиной корейки на гриле с золотистой корочкой и ароматом открытого огня.";
        }
    }

    // ── 2. Категория "Салаты" ──
    if (categoryId === "salads" || nameLower.startsWith("салат") || nameLower.includes("цезарь") || nameLower.includes("греческий")) {
        if (nameLower.includes("белоснежка")) {
            return "Фирменный салат кафе из нежного филе, свежих овощей, отборного сыра и авторской заправки от шеф-повара.";
        }
        if (nameLower.includes("цезарь с креветками")) {
            return "Хрустящие листья салата, обжаренные тигровые креветки, томаты черри, перепелиные яйца, пармезан и соус «Цезарь».";
        }
        if (nameLower.includes("цезарь с курицей")) {
            return "Классический салат с нежным филе цыпленка на гриле, листьями романо, хрустящими крутонами и соусом «Цезарь».";
        }
        if (nameLower.includes("цезарь с сёмгой") || nameLower.includes("цезарь с семгой")) {
            return "Изысканный салат со слабосолёной сёмгой, свежими листьями салата, томатами черри и сыром пармезан.";
        }
        if (nameLower.includes("греческий")) {
            return "Свежие огурцы, сладкий перец, сочные томаты, маслины и сыр фета с оливковым маслом и орегано.";
        }
        if (nameLower.includes("баклажан")) {
            return "Тёплый салат с хрустящими дольками баклажана, сладкими томатами, кинзой и кисло-сладкой заправкой.";
        }
        if (nameLower.includes("оригинальный")) {
            return "Изысканный фирменный салат с сочным куриным филе, свежими овощами, сыром и авторской заправкой.";
        }
        if (nameLower.includes("версаль")) {
            return "Нежный праздничный салат с отборными мясными деликатесами, сыром, сочными овощами и пикантным соусом.";
        }
        if (nameLower.includes("римский")) {
            return "Классический средиземноморский салат со свежими листьями, томатами черри, сыром и пряной заправкой.";
        }
        if (nameLower.includes("матадор")) {
            return "Сытный пикантный салат с говядиной, свежими овощами, зеленью и фирменной пряной заправкой.";
        }
        if (nameLower.includes("легкий") || nameLower.includes("лёгкий")) {
            return "Лёгкий витаминный салат из свежих хрустящих овощей и ароматной зелени с заправкой из оливкового масла.";
        }
        if (nameLower.includes("парус")) {
            return "Деликатесный салат с морепродуктами, свежими овощами и изысканной авторской заправкой.";
        }
        if (nameLower.includes("царский")) {
            return "Торжественный богатый салат со слабосолёной красной рыбой, икрой, сыром и свежими огурцами.";
        }
        if (nameLower.includes("лагуна")) {
            return "Нежный салат с морепродуктами, свежими огурчиками, яйцом и сливочной авторской заправкой.";
        }
        if (nameLower.includes("престиж")) {
            return "Сытный деликатесный салат из отборного мясного филе, свежих овощей и фирменного соуса от шеф-повара.";
        }
        if (nameLower.includes("каприз")) {
            return "Аппетитный слоёный салат из нежного филе, сыра, шампиньонов и свежих овощей.";
        }
        if (nameLower.includes("микс")) {
            return "Свежий микс хрустящих салатных листьев, сочных томатов черри и сладкого перца с легкой оливковой заправкой.";
        }
    ...
    if (categoryId === "starters") {
        if (nameLower.includes("рыбная тарелка")) {
            return "Изысканное деликатесное ассорти благородной рыбы: слабосолёная сёмга, масляная рыба, лимон, свежая зелень и оливки.";
        }
        if (nameLower.includes("мясная тарелка")) {
            return "Торжественная нарезка мясных деликатесов: ароматная буженина, бастурма, сыровяленая колбаса и свежая зелень.";
        }
        if (nameLower.includes("сырная тарелка")) {
            return "Ассорти благородных сыров с грецкими орехами, натуральным мёдом и свежим виноградом.";
        }
        if (nameLower.includes("сельдь с гарниром")) {
            return "Слабосолёная тихоокеанская сельдь с маринованным луком, отварным картофелем и свежей зеленью.";
        }
        if (nameLower.includes("овощная тарелка")) {
            return "Свежие грунтовые огурцы, сладкие томаты, болгарский перец, редис и пряная зелень.";
        }
        if (nameLower.includes("фруктовая тарелка")) {
            return "Сезонное ассорти свежих фруктов: яблоки, апельсины, виноград, банан и груша.";
        }
        if (nameLower.includes("рулеты из баклажана")) {
            return "Нежные рулетики из обжаренных баклажанов с пикантной орехово-сырной начинкой и чесноком.";
        }
        if (nameLower.includes("мексиканская")) {
            return "Пикантная острая закуска с кусочками мяса, перцем халапеньо, фасолью, кукурузой и пряными специями.";
        }
        if (nameLower.includes("креветки")) {
            return "Тигровые креветки, обжаренные в пикантном авторском чесночно-сливочном соусе.";
        }
        if (nameLower.includes("цезарь-ролл")) {
            return "Горячий запечённый ролл с аппетитной сырной корочкой, куриным филе, томатом и фирменным соусом.";
        }
        if (nameLower.includes("конвертики с курицей")) {
            return "Хрустящие горячие конвертики из слоёного теста с начинкой из сочного куриного филе и лука.";
        }
        if (nameLower.includes("конвертики с грибами")) {
            return "Аппетитные горячие конвертики из слоёного теста с ароматной грибной начинкой.";
        }
        ...
        if (nameLower.includes("луковые кольца")) {
            return "Хрустящие золотистые кольца репчатого лука в пивном кляре.";
        }
    ...
    if (categoryId === "hot") {
        ...
        if (nameLower.includes("жаркое по-армянски")) {
            return "Традиционное ароматное жаркое из сочной говядины, томленой с картофелем, сладким перцем и кавказскими травами.";
        }
        if (nameLower.includes("свинина с овощами")) {
            return "Ароматная свинина, приготовленная на сковороде со сладким перцем, репчатым луком и специями.";
        }
        ...
        if (nameLower.includes("печень по-татарски")) {
            return "Нежная печень, быстро обжаренная с луком и ароматными пряностями до мягкости и сочности.";
        }
        if (nameLower.includes("куриная грудка с овощами")) {
            return "Диетическое куриное филе со свежими тушеными овощами и душистыми травами.";
        }
        ...
        if (nameLower.includes("китайский дракон")) {
            return "Хрустящие кусочки филе в пикантном кисло-сладком соусе со свежей зеленью и обжаренным кунжутом.";
        }
        ...
        if (nameLower.includes("удон с курицей")) {
            return "Японская пшеничная лапша удон с нежным куриным филе и овощами вок в соусе терияки.";
        }
        if (nameLower.includes("удон с грибами")) {
            return "Пшеничная лапша удон со свежими шампиньонами и овощами в ароматном соусе.";
        }
        if (nameLower.includes("жареные пельмени с говядиной")) {
            return "Домашние пельмени с говядиной, обжаренные до аппетитной хрустящей корочки. Подаются со сметанным соусом.";
        }
        ...
        if (nameLower.includes("запечённый картофель") || nameLower.includes("запеченный картофель")) {
            return "Аппетитный картофель, запечённый в мундире до золотистой корочки с ароматными травами.";
        }
        if (nameLower.includes("овощи запечённые") || nameLower.includes("овощи на огне")) {
            return "Свежие сезонные овощи (болгарский перец, томаты, баклажаны), обжаренные на углях мангала.";
        }
        if (nameLower.includes("булгур")) {
            return "Рассыпчатый булгур, томленый с овощами и восточными пряностями.";
        }
        ...
        if (nameLower.includes("булочка к супу")) {
            return "Свежевыпеченная пшеничная булочка к первым блюдам.";
        }
    ...
    if (categoryId === "pizza_sauces" || nameLower.includes("пицца") || nameLower.startsWith("соус")) {
        ...
        if (nameLower.includes("грибная")) {
            return "Горячая пицца на тонком тесте со свежими шампиньонами, сливочным соусом и сыром моцарелла.";
        }
        if (nameLower.includes("гавайская")) {
            return "Классическая пицца с сочным куриным филе, кусочками ананаса, томатным соусом и сыром моцарелла.";
        }
    ...
    if (categoryId === "bar" || nameLower.includes("пиво") || nameLower.includes("водка") || nameLower.includes("коньяк") || nameLower.includes("виски") || nameLower.includes("вино") || nameLower.includes("коктейль") || nameLower.includes("шот")) {
        ...
        if (nameLower.includes("соки") || nameLower.includes("сок")) {
            return "Освежающий натуральный сок в ассортименте (1 л).";
        }
        if (nameLower === "кола" || nameLower.includes("кола")) {
            return "Классический прохладительный газированный напиток (1 л).";
        }
    ...
    if (categoryId === "banquet" || nameLower.includes("банкет") || nameLower.includes("бизнес-ланч") || nameLower.includes("праздник") || nameLower.includes("поминальн")) {
        ...
        if (nameLower.includes("свадебный банкет")) {
            return "Индивидуальное банкетное меню для свадьбы: торжественная сервировка стола, праздничные блюда, шашлык на углях и обслуживание в зале до 150 мест.";
        }
            ...
            >
                ...
                <div className="relative shrink-0 select-none overflow-hidden" style={{ height: "260px", background: "#2c1f0e" }}>
                    ...
                    <div className="absolute top-4 left-4 flex flex-wrap gap-2 items-center">
                        {dishTag && (
                            <span className="px-3 py-1 rounded-full text-xs font-semibold tracking-wide shadow-md" style={{ background: "#c8853a", color: "#1a1208", fontFamily: "var(--font-display)", fontWeight: 700 }}>
                                {dishTag}
                            </span>
                        )}
                    ...
                    <button
                        type="button"
                        onClick={onClose}
                        className="absolute top-4 right-4 w-9 h-9 rounded-full flex items-center justify-center text-xl transition-all duration-200 hover:scale-110 active:scale-95 shadow-lg cursor-pointer"
                ...
                <div className="p-6 overflow-y-auto flex flex-col gap-4" style={{ overscrollBehavior: "contain" }}>
                    ...
                    <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                        <button
                            ...
                            className="flex-1 py-3 px-5 rounded-xl text-xs uppercase tracking-widest font-bold transition-all duration-200 hover:brightness-110 active:scale-[0.98] shadow-lg flex items-center justify-center gap-2 text-center cursor-pointer"
    ...
    return (
        ...
        >
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="mt-6 px-6 py-2.5 rounded-full text-sm font-bold active:scale-[0.96] transition-transform"
                    style={{ background: "#c8853a", color: "#1a1208", fontFamily: "var(--font-display)", fontWeight: 700, boxShadow: "none" }}
                >
                    Закрыть
                </button>
            </div>
    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
                ...
                <button
                    onClick={onAccept}
                    className="shrink-0 px-5 py-2 rounded-full text-xs tracking-wide font-bold transition-[filter,transform] hover:brightness-110 active:scale-[0.96]"
                    style={{ background: "#c8853a", color: "#1a1208", fontFamily: "var(--font-display)", fontWeight: 700, whiteSpace: "nowrap", boxShadow: "none" }}
                >
...
function SuccessScreen({ onClose, text }: { onClose: () => void; text: string }) {
    return (
        <div className="text-center py-8">
            ...
            <button onClick={onClose} className="mt-6 px-6 py-2.5 rounded-full text-sm font-bold active:scale-[0.96] transition-transform"
                style={{ background: "#c8853a", color: "#1a1208", fontFamily: "var(--font-display)", fontWeight: 700, boxShadow: "none" }}>
                Закрыть
            </button>
        </div>
                ...
                <>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                                ...
                                {["1", "2", "3", "4", "5", "6+"].map(g => (
                                    <button key={g} type="button" onClick={() => setForm({ ...form, guests: g })} aria-pressed={form.guests === g}
                                        ...
                                        style={{
                                            ...
                                            fontWeight: form.guests === g ? 700 : 500,
                                            boxShadow: "none"
                                        }}>
                                        {g}
                                    </button>
                        ...
                        <button type="submit" disabled={!consent || loading || !form.time || !form.date}
                            className="mt-2 rounded-lg py-3 text-sm tracking-widest uppercase font-bold transition-[filter,transform,opacity] hover:brightness-110 active:scale-[0.96] disabled:opacity-40 disabled:cursor-not-allowed"
                            style={{ background: "#c8853a", color: "#1a1208", fontFamily: "var(--font-display)", letterSpacing: "0.12em", fontWeight: 700, boxShadow: "none" }}>
        ...
        <div style={{ fontFamily: "var(--font-body)", background: "#1a1208", color: "#f5ead8" }}>
                ...
                <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            onClick={openBooking}
                            className="hidden md:block px-5 py-2 rounded-full text-sm tracking-wide font-bold transition-[filter,transform] hover:brightness-110 active:scale-[0.96]"
                            style={{ background: "#c8853a", color: "#1a1208", fontFamily: "var(--font-display)", fontWeight: 700, boxShadow: "none" }}
                        >
                            Забронировать
                        </button>
                ...
                {menuOpen && (
                    <div className="md:hidden px-6 pb-6 pt-2 flex flex-col gap-4" style={{ background: "rgba(26,18,8,0.97)", boxShadow: "none" }}>
                        ...
                        <button
                            ...
                            className="mt-2 px-5 py-3 rounded-full text-sm tracking-wide font-bold transition-[filter,transform] hover:brightness-110 active:scale-[0.96]"
                            style={{ background: "#c8853a", color: "#1a1208", fontFamily: "var(--font-display)", fontWeight: 700, boxShadow: "none" }}
                        >
                            Забронировать
                        </button>
                ...
                <div className="relative max-w-6xl mx-auto px-6 w-full">
                    <div className="max-w-2xl">
                        ...
                        <div className="flex flex-wrap gap-4 items-center">
                            <button
                                onClick={openBooking}
                                className="px-8 py-3.5 rounded-full text-sm tracking-widest uppercase font-bold transition-[filter,transform] hover:brightness-110 active:scale-[0.96]"
                                style={{ background: "#c8853a", color: "#1a1208", fontFamily: "var(--font-display)", letterSpacing: "0.12em", fontWeight: 700, boxShadow: "none" }}
                            >
                                Забронировать
                            </button>
                        ...
                        {MENU_CATEGORIES_META.map((cat) => {
                            ...
                            return (
                                <button
                                    ...
                                    className="px-5 py-2 rounded-full text-xs tracking-wider uppercase font-bold transition-[background-color,color,border-color,transform] active:scale-[0.96] cursor-pointer"
                                    style={{
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-3 items-center shrink-0">
                            <button
                                type="button"
                                onClick={openBooking}
                                className="px-6 py-3 rounded-full text-xs tracking-wider uppercase font-bold transition-[filter,transform] hover:brightness-110 active:scale-[0.96] cursor-pointer"
                                style={{
                                    background: "#c8853a",
                                    color: "#1a1208",
                                    fontFamily: "var(--font-display)",
                        ...
                        {[
                            ...
                            return (
                                <button
                                    ...
                                    className="px-5 py-2 rounded-full text-xs tracking-wider uppercase font-bold transition-[background-color,color,border-color,transform] active:scale-[0.96]"
                                    style={{
                                        background: isActive ? "#c8853a" : "#231808",
                                        color: isActive ? "#1a1208" : "#d9c9b0",
                                        border: `1px solid ${isActive ? "#c8853a" : "#c8853a33"}`,
                            ...
                            >
                                ...
                                <div className="pt-4 border-t" style={{ borderColor: "#c8853a22" }}>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-3 rounded-xl text-xs tracking-widest uppercase font-bold transition-[filter,transform] hover:brightness-110 active:scale-[0.96] flex items-center justify-center gap-2 cursor-pointer"
                                        style={{
                                            background: "#c8853a",
                                            color: "#1a1208",
                                            fontFamily: "var(--font-display)",
            ...
            <section className="py-24 relative overflow-hidden" style={{ background: "#c8853a" }}>
                ...
                <div className="relative max-w-3xl mx-auto px-6 text-center">
                    ...
                    <button
                        onClick={openBooking}
                        className="px-10 py-4 rounded-full text-sm tracking-widest uppercase font-bold transition-[background-color,transform] hover:brightness-110 active:scale-[0.96] cursor-pointer"
                        style={{ background: "#1a1208", color: "#c8853a", fontFamily: "var(--font-display)", fontWeight: 700, letterSpacing: "0.14em", boxShadow: "none" }}
                    >
                        Забронировать
                    </button>
                </div>
